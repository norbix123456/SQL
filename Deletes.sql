DELETE FROM Room WHERE Adress='Kopernika 1';
DELETE FROM Party WHERE Name_party='PiwoiWóda';
DELETE FROM Guard WHERE Guard_ID='G1';
DELETE FROM Attendance WHERE Attendance_ID='ATT10';
DELETE FROM Vote WHERE Vote_ID='V8';
DELETE FROM Protection WHERE Session_='S4';
DELETE FROM Inside WHERE Politician='P2';
SELECT * FROM Room;
SELECT * FROM Politician;
SELECT * FROM Party;
SELECT * FROM Guard;
SELECT * FROM Politician_cadency;
SELECT * FROM Marshal_cadency;
...
/*Marsha³kowie których partia jest ma³a i obradowali przy du¿ej iloœci polityków*/
